import { p as a, H as i, c as e, h as l, t } from './p-e4O_lm9q.js';
import { c as d } from './p-D7YaJBkB.js';
import { g as n } from './p-CjVOT-ld.js';
import { f as o, a as s } from './p-6ELf7sgg.js';
import { r } from './p-DkWO1r6B.js';
import { d as p } from './p-C_9NSgFc.js';
import { d as h } from './p-C1ZIotiF.js';
import { d as k } from './p-BUkoTX2-.js';
import { d as u } from './p-DWoI2h-p.js';
import { v as b } from './p-CK3_k8jD.js';
const m = [
    { label: 'Afghanistan', id: 'AF', dialCode: '+93', mask: '999 99 999 9999' },
    { label: 'Åland Islands', id: 'AX', dialCode: '+358', mask: '99 999 99 99' },
    ...
    { label: 'Bonaire, Sint Eustatius and Saba', id: 'BQ', dialCode: '+599', mask: '999 9999' },
    ...
    { label: 'Eswatini', id: 'SZ', dialCode: '+268', mask: '99 99 9999' },
    ...
    { label: 'Kosovo', id: 'XK', dialCode: '+383', mask: '999 999 999' },
    ...
    { label: 'Libya', id: 'LY', dialCode: '+218', mask: '99-9999999' },
    ...
    { label: 'Macau', id: 'MO', dialCode: '+853', mask: '9999 9999' },
    { label: 'Republic of North Macedonia', id: 'MK', dialCode: '+389', mask: '99 999 999' },
    ...
    { label: 'Republic of Moldova', id: 'MD', dialCode: '+373', mask: '9999 99999' },
    { label: 'Monaco', id: 'MC', dialCode: '+377', mask: '99 99 99 99' },
    { label: 'Mongolia', id: 'MN', dialCode: '+976', mask: '9999-9999' },
    { label: 'Montenegro', id: 'ME', dialCode: '+382', mask: '99 999 999' },
    ...
    { label: 'State of Palestine', id: 'PS', dialCode: '+970', mask: '99 999-9999' },
    ...
    { label: 'Réunion', id: 'RE', dialCode: '+262', mask: '99999-9999' },
    ...
    { label: 'Saint Barthélemy', id: 'BL', dialCode: '+590', mask: '999 99 99 99' },
    ...
    { label: 'Sint Maarten', id: 'SX', dialCode: '+1721', mask: '(999) 999-9999' },
    { label: 'Saint Martin', id: 'MF', dialCode: '+590', mask: '999 99 99 99' },
    ...
    { label: 'São Tomé and Príncipe', id: 'ST', dialCode: '+239', mask: '9 999999' },
    { label: 'Saudi Arabia', id: 'SA', dialCode: '+966', mask: '99 999 9999' },
    { label: 'Senegal', id: 'SN', dialCode: '+221', mask: '99 999 99 99' },
    { label: 'Serbia', id: 'RS', dialCode: '+381', mask: '99 999-9999' },
    ...
    { label: 'South Sudan', id: 'SS', dialCode: '+211', mask: '99 999 9999' },
    ...
    { label: 'Suriname', id: 'SR', dialCode: '+597', mask: '999-9999' },
    ...
    class extends i {
      constructor(a) {
        (super(),
          ...
          (this.tkChange = e(this, 'tk-change', 5)),
          (this.tkBlur = e(this, 'tk-blur', 7)),
          (this.tkFocus = e(this, 'tk-focus', 7)),
          (this.uniqueId = b()),
          (this.countries = []),
          (this.inputValue = ''),
          (this.hasFocus = !1),
          ...
          (this.toggleDropdown = () => {
            var a;
            this.disabled || ((this.isDropdownOpen = !this.isDropdownOpen), this.isDropdownOpen && (null === (a = this.searchInput) || void 0 === a || a.focus()));
          }),
          (this.handleCountrySelect = a => {
            var i;
            (this.setSelectedCountry(a.id),
              (this.value = {
                rawValue: '',
                maskedValue: '',
                country: {
          ...
          (this.handleClickOutside = a => {
            this.el.contains(a.target) || (this.isDropdownOpen = !1);
          }),
          (this.handleSearchChange = a => {
            this.searchTerm = a.target.value;
          }),
          (this.handleInput = a => {
            var i;
            const e = a.target,
              l = e.value.replace(/\D/g, '');
            if (!(null === (i = this.selectedCountry.mask) || void 0 === i ? void 0 : i.length))
              return (
                (this.inputValue = l),
                ...
                void this.tkChange.emit(this.value)
              );
            const t = this.selectedCountry.mask,
              d = (t.match(/9/g) || []).length;
            if (l.length > d || /[^\d() -]/.test(e.value)) return (this.inputRef.value = this.inputValue);
            ((this.hasFocus = !1),
              (this.inputValue = this.applyMask(l, t)),
              (this.inputRef.value = this.inputValue),
              (this.value = {
                rawValue: l,
          ...
          (this.handleInputBlur = () => {
            ((this.hasFocus = !1), this.tkBlur.emit());
          }),
          (this.handleInputFocus = () => {
            ((this.hasFocus = !0), this.tkFocus.emit());
          }),
          (this.handleFormReset = () => {
            ...
            ((this.value = {
              ...
              (this.inputRef.value = ''),
              (this.searchTerm = ''),
              null === (a = this.inputRef) || void 0 === a || a.focus());
          }));
      }
      valueChanged(a) {
        var i, e;
        ((!a || ('object' == typeof a && 0 === Object.keys(a).length)) && this.handleFormReset(),
          a.rawValue || a.maskedValue || (this.inputValue = ''),
          a &&
            ((null === (i = null == a ? void 0 : a.country) || void 0 === i ? void 0 : i.id) &&
              this.setSelectedCountry(null === (e = null == a ? void 0 : a.country) || void 0 === e ? void 0 : e.id),
            (this.inputValue = this.applyMask(a.rawValue, this.selectedCountry.mask))));
      }
      disabledChanged(a) {
        a && (this.isDropdownOpen = !1);
      }
      connectedCallback() {
      ...
      disconnectedCallback() {
        var a;
        (null === (a = this.cleanup) || void 0 === a || a.call(this), (this.cleanup = null), document.removeEventListener('click', this.handleClickOutside));
      }
      componentWillLoad() {
        var a, i, e, l;
        (this.initializeCountries(),
          (null == this ? void 0 : this.value) && (null === (a = Object.keys(null == this ? void 0 : this.value)) || void 0 === a ? void 0 : a.length)
            ? ((null === (e = null === (i = this.value) || void 0 === i ? void 0 : i.country) || void 0 === e ? void 0 : e.id) && this.setSelectedCountry(this.value.country.id),
              (this.inputValue = this.applyMask(
                null === (l = null == this ? void 0 : this.value) || void 0 === l ? void 0 : l.rawValue,
                null == this ? void 0 : this.selectedCountry.mask,
              )))
      ...
      componentDidUpdate() {
        var a, i, e;
        this.isDropdownOpen
          ? (null === (a = this.cleanup) || void 0 === a || a.call(this), this.updatePosition())
          : (null === (i = this.cleanup) || void 0 === i || i.call(this), (this.cleanup = null), null === (e = this.panelRef) || void 0 === e || e.remove());
      }
      formResetCallback() {
        this.handleFormReset();
      }
      updatePosition() {
        const a = this.dropdownWidthMode,
          i = this.el.querySelector('.tk-phone-input-wrapper');
        this.cleanup = o(i, this.panelRef, void 0, {
          placement: 'bottom-start',
          size: {
            apply({ rects: i, elements: e }) {
              'match-parent' === a ? s(e.floating, { width: i.reference.width + 'px' }) : 'auto' !== a && a.length > 0 && s(e.floating, { width: a });
            },
          },
        });
      }
      initializeCountries() {
        this.countries = this.countryList ? this.countryList : m;
      }
      setSelectedCountry(a) {
        const i = this.countries.find(i => i.id.toUpperCase() === a.toUpperCase());
        this.selectedCountry = i || this.countries[0];
      }
      applyMask(a, i) {
        if (!(null == i ? void 0 : i.length) || !(null == a ? void 0 : a.length)) return a;
        let e = '',
          l = 0;
        for (let t = 0; t < i.length && l < a.length; t++) e += '9' === i[t] ? a[l++] : i[t];
        return e;
      }
      getFilteredCountries() {
        const a = this.searchTerm.toLowerCase();
        return a
          ? this.countries.filter(i => {
              var e;
              return i.label.toLowerCase().includes(a) || (null === (e = i.dialCode) || void 0 === e ? void 0 : e.includes(a));
            })
          : this.countries;
      }
      getFlagClass(a) {
        return d('flag', (null == a ? void 0 : a.dialCode) ? 'flag-' + (null == a ? void 0 : a.id.toLowerCase()) : 'flag-none');
      }
      renderLabel() {
        var a;
        let i;
        if ((null === (a = this.label) || void 0 === a ? void 0 : a.length) > 0) {
          const a = l('span', { class: 'tk-phone-input-asterisk' }, '*');
          i = l('label', { htmlFor: this.uniqueId, class: 'tk-phone-input-label' }, this.label, this.showAsterisk ? a : '');
        }
        return i;
      }
      renderCountrySelector() {
        return l(
          'div',
          { class: 'tk-phone-input-dropdown' },
          this.createDropdownButton(),
          this.isDropdownOpen &&
            l('div', { class: 'tk-phone-input-dropdown-menu', role: 'listbox', ref: a => (this.panelRef = a) }, this.createDropdownSearch(), this.createDropdownList()),
        );
      }
      createDropdownButton() {
        const a = d('tk-phone-input-dropdown-button-selected', { 'tk-phone-input-no-dial-code': !this.selectedCountry.dialCode });
        return l(
          'button',
          { class: 'tk-phone-input-dropdown-button', onClick: this.toggleDropdown, type: 'button' },
          l(
            'div',
            { class: a },
            l('tk-icon', Object.assign({}, n('stat_minus_1', { variant: null, size: 'large' }, 'rounded', 'span'))),
            !this.hideFlag && this.renderFlag(this.selectedCountry),
            this.selectedCountry.dialCode && l('span', { class: 'tk-phone-input-dial-code' }, this.selectedCountry.dialCode),
          ),
        );
      }
      ...
      createDropdownList() {
        return l(
          'ul',
          { class: 'tk-phone-input-menu' },
          this.getFilteredCountries().map(a =>
            l(
              'li',
              {
                'class': 'tk-phone-input-menu-item',
                'onClick': () => this.handleCountrySelect(a),
                'key': a.id,
                'role': 'option',
                'aria-selected': a.id === this.selectedCountry.id,
              },
              !this.hideFlag && this.renderFlag(a),
              a.label && l('span', { class: 'tk-phone-input-menu-country-label' }, a.label),
              a.dialCode && l('span', { class: 'tk-phone-input-menu-dial-id' }, a.dialCode),
            ),
          ),
        );
      }
      renderPhoneInput() {
        ...
        return l('input', {
          ...
          autoComplete: 'off',
          placeholder:
            (null === (a = this.selectedCountry) || void 0 === a ? void 0 : a.placeholder) ||
            this.placeholder ||
            (null === (i = this.selectedCountry.mask) || void 0 === i ? void 0 : i.replace(/9/g, '9')),
      ...
      renderFlag(a) {
        const i = this.getFlagClass(a);
        return a.dialCode
          ? l('div', { 'class': i, 'aria-label': a.label + ' flag' })
          : l('div', { class: i }, l('tk-icon', Object.assign({}, n('close', { color: 'var(--static-white)' }))));
      }
      render() {
        return l(
          'div',
          {
            'key': '5100f416234e8b8526fa2aa89079084af9776f7e',
            'class': d('tk-phone-input-container', 'tk-phone-input-container-' + this.size),
            'aria-invalid': this.invalid,
            'aria-disabled': this.disabled,
            'aria-readonly': this.readonly,
          },
          this.renderLabel(),
          l('div', { key: '2856c3cbcf42a8e12971f8b2b7519be261a15178', class: 'tk-phone-input-wrapper' }, this.renderCountrySelector(), this.renderPhoneInput()),
          r(this.hint, this.error, this.invalid),
        );
      }
      ...
      static get watchers() {
        return { value: [{ valueChanged: 0 }], disabled: [{ disabledChanged: 0 }] };
      }
      static get style() {
        return '@font-face{font-family:"Material Symbols Outlined";src:url("./assets/fonts/material-symbols/Material-Symbols-Outlined.woff2") format("woff2");font-weight:400;font-style:normal;font-display:swap}.material-symbols-outlined{font-family:"Material Symbols Outlined";font-weight:normal;font-style:normal;font-size:24px;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:"liga";-webkit-font-smoothing:antialiased}.material-symbols-outlined{font-variation-settings:"FILL" 0}.material-symbols-outlined.fill{font-variation-settings:"FILL" 1}@font-face{font-family:"Material Symbols Rounded";src:url("./assets/fonts/material-symbols/Material-Symbols-Rounded.woff2") format("woff2");font-weight:400;font-style:normal;font-display:swap}.material-symbols-rounded{font-family:"Material Symbols Rounded";font-weight:normal;font-style:normal;font-size:24px;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:"liga";-webkit-font-smoothing:antialiased}.material-symbols-rounded{font-variation-settings:"FILL" 0}.material-symbols-rounded.fill{font-variation-settings:"FILL" 1}@font-face{font-family:"Material Symbols Sharp";src:url("./assets/fonts/material-symbols/Material-Symbols-Sharp.woff2") format("woff2");font-weight:400;font-style:normal;font-display:swap}.material-symbols-sharp{font-family:"Material Symbols Sharp";font-weight:normal;font-style:normal;font-size:24px;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:"liga";-webkit-font-smoothing:antialiased}.material-symbols-sharp{font-variation-settings:"FILL" 0}.material-symbols-sharp.fill{font-variation-settings:"FILL" 1}:host{display:block;min-width:0}.tk-phone-input-container{display:flex;flex-direction:column;align-items:flex-start;color:var(--text-darkest);font-family:var(--family-body);gap:var(--input-external-label-small-container-gap);min-width:0}.tk-phone-input-container .tk-phone-input-label{font-weight:var(--weight-regular);gap:var(--input-external-label-small-container-gap)}.tk-phone-input-container .tk-phone-input-wrapper{display:flex;align-items:center;gap:var(--input-external-label-small-container-gap);align-self:stretch;border-radius:var(--button-sizes-large-radius);border:var(--spacing-px) solid var(--border-light);background:var(--static-light);overflow:hidden}.tk-phone-input-container .tk-phone-input-wrapper:focus{border:var(--spacing-px) solid var(--states-info-base)}.tk-phone-input-container .tk-phone-input-wrapper:hover{background-color:var(--background-lightest)}.tk-phone-input-container .tk-phone-input-dropdown{flex-shrink:0}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-button{cursor:pointer;display:flex;align-items:center;border:none;background-color:transparent;padding:0}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-button .tk-phone-input-dropdown-button-selected{display:flex;align-items:center;gap:var(--spacing-xs);border-right:var(--spacing-px) solid var(--border-light)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-button .tk-phone-input-dropdown-button-selected .tk-phone-input-dial-code{padding-right:var(--input-external-label-large-label-h-padding)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-button .tk-phone-input-dropdown-button-selected.tk-phone-input-no-dial-code{padding-right:var(--input-external-label-large-label-h-padding)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu{position:fixed;z-index:800;background:var(--static-light);border:var(--spacing-px) solid var(--border-light);border-radius:var(--button-sizes-large-radius);box-shadow:var(--effect-1-default-sm);display:flex;flex-direction:column;overflow:hidden}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-dropdown-menu-search{padding:var(--spacing-m-base)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu{list-style:none;overflow-y:auto;margin:var(--spacing-m-base)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu::-webkit-scrollbar{width:4px;height:4px}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu::-webkit-scrollbar-track{background:var(--background-lightest);border-radius:2px}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu::-webkit-scrollbar-thumb{border-radius:3px;background:var(--secondary-sub-base)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu::-webkit-scrollbar-thumb:hover{background:var(--secondary-dark)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu::-webkit-scrollbar-corner{background:var(--background-lightest)}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu .tk-phone-input-menu-item{display:flex;align-items:center;gap:var(--spacing-xs);padding:var(--input-external-label-base-input-v-padding) var(--spacing-4xl);cursor:pointer;transition:background-color 0.2s}.tk-phone-input-container .tk-phone-input-dropdown .tk-phone-input-dropdown-menu .tk-phone-input-menu .tk-phone-input-menu-item:hover{background-color:var(--background-lightest)}.tk-phone-input-container .tk-phone-input-input{flex:1;min-width:0;border:none;background-color:transparent;outline:none}.tk-phone-input-container .tk-phone-input-input::placeholder{color:var(--text-sub-base)}.tk-phone-input-container[aria-invalid] .tk-phone-input-wrapper{border-color:var(--states-danger-base)}.tk-phone-input-container[aria-disabled],.tk-phone-input-container[aria-readonly]{pointer-events:none}.tk-phone-input-container[aria-disabled] .tk-phone-input-wrapper,.tk-phone-input-container[aria-readonly] .tk-phone-input-wrapper{background-color:var(--background-lightest)}.tk-phone-input-container[aria-disabled] .tk-phone-input-label,.tk-phone-input-container[aria-disabled] .tk-phone-input-label-asterisk,.tk-phone-input-container[aria-disabled] .tk-phone-input-dropdown-button,.tk-phone-input-container[aria-readonly] .tk-phone-input-label,.tk-phone-input-container[aria-readonly] .tk-phone-input-label-asterisk,.tk-phone-input-container[aria-readonly] .tk-phone-input-dropdown-button{color:var(--text-sub-base)}.tk-phone-input-container[aria-disabled] .tk-phone-input-input{color:var(--text-sub-base)}.tk-phone-input-container.tk-phone-input-container-large{font-size:var(--desktop-label-l-size);line-height:var(--desktop-label-l-line-height)}.tk-phone-input-container.tk-phone-input-container-large .tk-phone-input-wrapper{height:var(--spacing-12xl);padding:var(--input-external-label-large-input-v-padding) var(--input-external-label-large-input-h-padding)}.tk-phone-input-container.tk-phone-input-container-large .tk-phone-input-wrapper .tk-phone-input-dropdown-button,.tk-phone-input-container.tk-phone-input-container-large .tk-phone-input-wrapper .tk-phone-input-input{font-size:var(--desktop-label-l-size)}.tk-phone-input-container.tk-phone-input-container-large .tk-phone-input-label{padding:var(--input-external-label-large-label-v-padding) var(--input-external-label-large-label-h-padding)}.tk-phone-input-container.tk-phone-input-container-large .tk-phone-input-menu{max-height:288px}.tk-phone-input-container.tk-phone-input-container-base{font-size:var(--desktop-label-m-base-size);line-height:var(--desktop-label-m-base-line-height)}.tk-phone-input-container.tk-phone-input-container-base .tk-phone-input-wrapper{height:var(--spacing-10xl);padding:var(--input-external-label-base-input-v-padding) var(--input-external-label-base-input-h-padding)}.tk-phone-input-container.tk-phone-input-container-base .tk-phone-input-wrapper .tk-phone-input-dropdown-button,.tk-phone-input-container.tk-phone-input-container-base .tk-phone-input-wrapper .tk-phone-input-input{font-size:var(--desktop-label-m-base-size)}.tk-phone-input-container.tk-phone-input-container-base .tk-phone-input-label{padding:var(--input-external-label-base-label-v-padding) var(--input-external-label-base-label-h-padding)}.tk-phone-input-container.tk-phone-input-container-base .tk-phone-input-menu{max-height:276px}.tk-phone-input-container.tk-phone-input-container-small{font-size:var(--desktop-label-s-size);line-height:var(--desktop-label-s-line-height)}.tk-phone-input-container.tk-phone-input-container-small .tk-phone-input-wrapper{height:var(--spacing-8xl);padding:var(--input-external-label-small-input-v-padding) var(--input-external-label-small-input-h-padding)}.tk-phone-input-container.tk-phone-input-container-small .tk-phone-input-wrapper .tk-phone-input-dropdown-button,.tk-phone-input-container.tk-phone-input-container-small .tk-phone-input-wrapper .tk-phone-input-input{font-size:var(--desktop-label-s-size)}.tk-phone-input-container.tk-phone-input-container-small .tk-phone-input-label{padding:var(--input-external-label-small-label-v-padding) var(--input-external-label-small-label-h-padding)}.tk-phone-input-container.tk-phone-input-container-small .tk-phone-input-menu{max-height:264px}.tk-phone-input-container .tk-phone-input-asterisk{color:var(--states-danger-base);font-size:var(--desktop-label-s-size);line-height:var(--desktop-label-s-line-height);font-weight:var(--weight-light)}';
      }
    },
    [
      64,
      ...
      void 0,
      { value: [{ valueChanged: 0 }], disabled: [{ disabledChanged: 0 }] },
    ],
  ),
  C = c,
  g = function () {
    'undefined' != typeof customElements &&
      ['tk-phone-input', 'tk-chips', 'tk-icon', 'tk-input', 'tk-spinner'].forEach(a => {
        switch (a) {
          case 'tk-phone-input':
            customElements.get(t(a)) || customElements.define(t(a), c);
            break;
          case 'tk-chips':
            customElements.get(t(a)) || p();
            break;
          case 'tk-icon':
            customElements.get(t(a)) || h();
            break;
          case 'tk-input':
            customElements.get(t(a)) || k();
            break;
          case 'tk-spinner':
            customElements.get(t(a)) || u();
        }
      });
  };
export { C as TkPhoneInput, g as defineCustomElement };
