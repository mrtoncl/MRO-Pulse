...
export function floatingElementAutoUpdate(triggerElement, floatingElement, arrowElement, options, handlePlacement) {
    return autoUpdate(triggerElement, floatingElement, () => {
        positionFloatingElement(triggerElement, floatingElement, arrowElement, options).then(position => handlePlacement === null || handlePlacement === void 0 ? void 0 : handlePlacement(position));
    }, { animationFrame: true });
}
