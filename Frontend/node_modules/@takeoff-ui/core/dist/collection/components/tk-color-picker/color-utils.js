 ...
 */
export function rgbToHsla(r, g, b, a) {
    r /= 255;
    g /= 255;
    b /= 255;
 ...
 */
export function hslaToCss(hsla, format) {
    const { h, s, l, a } = hsla;
    switch (format) {
        case 'hex':
 ...
 */
export function rgbToHsva(r, g, b, a = 1) {
    r /= 255;
    g /= 255;
    b /= 255;
    const max = Math.max(r, g, b);
 ...
 * @returns CSS color string
 */
export function hsvaToCss(hsva, format) {
    const { h, s, v, a } = hsva;
    switch (format) {
        case 'hex':
 ...
 * @returns HSVA color object
 */
export function parseColorToHsva(input) {
    if (!input)
