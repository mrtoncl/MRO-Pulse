...
const TkPhoneInput = class {
    constructor(hostRef) {
        ...
        this.handleInput = (event) => {
            ...
            if (!((_a = this.selectedCountry.mask) === null || _a === void 0 ? void 0 : _a.length)) {
            ...
            if (rawValue.length > maxDigits || hasInvalidCharacters)
                return (this.inputRef.value = this.inputValue);
            this.hasFocus = false;
    ...
    componentWillLoad() {
        ...
        if ((this === null || this === void 0 ? void 0 : this.value) && ((_a = Object.keys(this === null || this === void 0 ? void 0 : this.value)) === null || _a === void 0 ? void 0 : _a.length)) {
            ...
            this.inputValue = this.applyMask((_d = this === null || this === void 0 ? void 0 : this.value) === null || _d === void 0 ? void 0 : _d.rawValue, this === null || this === void 0 ? void 0 : this.selectedCountry.mask);
        }
        else {
    ...
    componentDidUpdate() {
        ...
        if (this.isDropdownOpen) {
            ...
            // Clear reference to allow garbage collection
            this.cleanup = null;
            (_c = this.panelRef) === null || _c === void 0 ? void 0 : _c.remove();
        }
    }
    formResetCallback() {
        this.handleFormReset();
    ...
    updatePosition() {
        ...
        const tkInputRootEl = this.el.querySelector('.tk-phone-input-wrapper');
        this.cleanup = positionUtils.floatingElementAutoUpdate(tkInputRootEl, this.panelRef, undefined, {
            placement: 'bottom-start',
            size: {
                apply({ rects, elements }) {
                    if (dropdownWidthMode === 'match-parent') {
                        positionUtils.applyStyles(elements.floating, {
    ...
    applyMask(rawValue, mask) {
        if (!(mask === null || mask === void 0 ? void 0 : mask.length) || !(rawValue === null || rawValue === void 0 ? void 0 : rawValue.length))
            return rawValue;
        let maskedValue = '';
        let digitIndex = 0;
    ...
    getFilteredCountries() {
        ...
        return this.countries.filter(country => { var _a; return country.label.toLowerCase().includes(term) || ((_a = country.dialCode) === null || _a === void 0 ? void 0 : _a.includes(term)); });
    }
    /**
     * Get the flag class based on the country object.
     */
    getFlagClass(country) {
        return index$1.classNames('flag', (country === null || country === void 0 ? void 0 : country.dialCode) ? `flag-${country === null || country === void 0 ? void 0 : country.id.toLowerCase()}` : 'flag-none');
    }
    renderLabel() {
        var _a;
        let label;
        if (((_a = this.label) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            const asterisk = index.h("span", { class: "tk-phone-input-asterisk" }, "*");
            label = (index.h("label", { htmlFor: this.uniqueId, class: "tk-phone-input-label" }, this.label, this.showAsterisk ? asterisk : ''));
        }
        return label;
    }
    /**
    ...
    renderCountrySelector() {
        return (index.h("div", { class: "tk-phone-input-dropdown" }, this.createDropdownButton(), this.isDropdownOpen && (index.h("div", { class: "tk-phone-input-dropdown-menu", role: "listbox", ref: el => (this.panelRef = el) }, this.createDropdownSearch(), this.createDropdownList()))));
    }
    /**
     * Create the dropdown button for selecting a country.
     */
    createDropdownButton() {
        const selectedClass = index$1.classNames('tk-phone-input-dropdown-button-selected', {
            'tk-phone-input-no-dial-code': !this.selectedCountry.dialCode,
        });
        return (index.h("button", { class: "tk-phone-input-dropdown-button", onClick: this.toggleDropdown, type: "button" }, index.h("div", { class: selectedClass }, index.h("tk-icon", Object.assign({}, iconUtils.getIconElementProps('stat_minus_1', { variant: null, size: 'large' }, 'rounded', 'span'))), !this.hideFlag && this.renderFlag(this.selectedCountry), this.selectedCountry.dialCode && index.h("span", { class: "tk-phone-input-dial-code" }, this.selectedCountry.dialCode))));
    }
    /**
     * Create the search input for filtering countries in the dropdown.
     */
    createDropdownSearch() {
        return (index.h("tk-input", { class: "tk-phone-input-dropdown-menu-search", size: this.size, placeholder: "Search", value: this.searchTerm, "onTk-change": this.handleSearchChange, ref: el => (this.searchInput = el), icon: "search", iconPosition: "right", onClick: (e) => e.stopPropagation() }));
    }
    /**
     * Create the dropdown list of countries.
     */
    createDropdownList() {
        return (index.h("ul", { class: "tk-phone-input-menu" }, this.getFilteredCountries().map(country => (index.h("li", { class: "tk-phone-input-menu-item", onClick: () => this.handleCountrySelect(country), key: country.id, role: "option", "aria-selected": country.id === this.selectedCountry.id }, !this.hideFlag && this.renderFlag(country), country.label && index.h("span", { class: "tk-phone-input-menu-country-label" }, country.label), country.dialCode && index.h("span", { class: "tk-phone-input-menu-dial-id" }, country.dialCode))))));
    }
    /**
    ...
    renderPhoneInput() {
        var _a, _b;
        return (index.h("input", { id: this.uniqueId, type: "tel", class: "tk-phone-input-input", autoComplete: "off", placeholder: ((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.placeholder) || this.placeholder || ((_b = this.selectedCountry.mask) === null || _b === void 0 ? void 0 : _b.replace(/9/g, '9')), value: this.inputValue, onInput: this.handleInput, onBlur: this.handleInputBlur, onFocus: this.handleInputFocus, disabled: this.disabled, ref: el => (this.inputRef = el) }));
    }
    /**
    ...
    renderFlag(country) {
        ...
        return country.dialCode ? (index.h("div", { class: flagClass, "aria-label": `${country.label} flag` })) : (index.h("div", { class: flagClass }, index.h("tk-icon", Object.assign({}, iconUtils.getIconElementProps('close', { color: 'var(--static-white)' })))));
    }
    /**
     * Render the component.
     */
    render() {
        return (index.h("div", { key: '5100f416234e8b8526fa2aa89079084af9776f7e', class: index$1.classNames('tk-phone-input-container', `tk-phone-input-container-${this.size}`), "aria-invalid": this.invalid, "aria-disabled": this.disabled, "aria-readonly": this.readonly }, this.renderLabel(), index.h("div", { key: '2856c3cbcf42a8e12971f8b2b7519be261a15178', class: "tk-phone-input-wrapper" }, this.renderCountrySelector(), this.renderPhoneInput()), hintUtils.renderHint(this.hint, this.error, this.invalid)));
    }
...
TkPhoneInput.style = tkPhoneInputCss();

exports.tk_phone_input = TkPhoneInput;
