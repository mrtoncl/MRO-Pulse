...
const TkTooltip = class {
    ...
    updatePosition() {
        this.cleanup = positionUtils.floatingElementAutoUpdate(this.triggerElement, this.tooltipElement, this.arrowElement, { placement: this.position });
    }
    render() {
        let _leftIcon;
        let _rightIcon;
        ...
        return (index.h("div", { key: 'e103d269627b7086bc9338116cc0bf2c912c9939', class: "tk-tooltip", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'container') }, index.h("slot", { key: 'f0970482cd375ec1975c5d737183e943824d79e2', name: "trigger" }), this.isOpen && (index.h("div", { key: '72dad9abf9e52a20aee2970c6a7806d91fc835fb', ref: el => (this.tooltipElement = el), class: {
                'tk-tooltip-content': true,
                [`tk-tooltip-${this.variant}`]: !!this.variant,
            }, style: Object.assign({}, this.containerStyle), role: "tooltip", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'content') }, this.hasContentSlot ? (index.h("slot", { name: "content" })) : (index.h(index.Fragment, null, _leftIcon, index.h("div", null, index.h("div", { class: "tk-tooltip-header", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'header') }, this.header), index.h("div", { class: "tk-tooltip-description", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'description') }, this.description)), _rightIcon)), index.h("div", { key: '4671062739e1f81aa5e5adee0fae47132cfd3335', ref: el => (this.arrowElement = el), class: "tk-tooltip-arrow", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'arrow') })))));
    }
...
TkTooltip.style = tkTooltipCss();

exports.tk_tooltip = TkTooltip;
