...
var merge = require('./merge-CgctTlcr.js');
...
class OrgChart {
    ...
    render() {
        ...
        attrs.flexTreeLayout = flextree({
            nodeSize: node => {
                const width = attrs.nodeWidth(node);                const height = attrs.nodeHeight(node);
    ...
    downloadImage({ node, scale = 2, imageName = 'graph', isSvg = false, save = true, backgroundColor = "#FAFAFA", onAlreadySerialized = d => { }, onLoad = d => { } }) {
        ...
        image.onload = function () {
            ...
            context.fillStyle = backgroundColor;            context.fillRect(0, 0, rect.width * quality, rect.height * quality);
...
const TkOrgChart = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.tkNodeClick = index.createEvent(this, "tk-node-click", 7);
        this.nodeWidth = 160;
        this.nodeHeight = 90;
...
">
    ...
    mergeOptions() {
        this.internalOptions = merge.merge({}, {}, this.options);
    }
    updateOrgChart() {
        if (!this.orgChartInstance)
            return;
...
>
    ...
    render() {
        var _a, _b;
        const accessibilityLabel = this.accessibilityLabel || ((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.title) === null || _b === void 0 ? void 0 : _b.text) || 'Organization Chart';
        return index.h("div", { key: 'f203f2fe605a46d8cc7f06600d1bbe2c9365adce', ref: el => (this.orgChartContainerRef = el), class: "tk-org-chart-container", role: "img", "aria-label": accessibilityLabel });
    }
    ...
    static get watchers() { return {
        ...
        "collapsible": [{
                "collapsibleChanged": 0
            }]
    }; }
};
TkOrgChart.style = tkOrgChartCss();

exports.tk_org_chart = TkOrgChart;
