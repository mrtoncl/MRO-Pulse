...
const TkPopover = class {
    ...
    disconnectedCallback() {
        ...
        (_d = this.cleanup) === null || _d === void 0 ? void 0 : _d.call(this);
        // Clear reference to allow garbage collection
        this.cleanup = null;
        // Call mixin's disconnectedCallback for cleanup
        (_e = this.clickOutsideMixin) === null || _e === void 0 ? void 0 : _e.disconnectedCallback();
    }
    componentDidUpdate() {
        var _a, _b;
    ...
    updatePosition() {
        this.cleanup = positionUtils.floatingElementAutoUpdate(this.triggerElement, this.popoverElement, this.arrowElement, { placement: this.position });
    }
    /**
    ...
    showInTopLayer() {
        ...
        if (typeof (el === null || el === void 0 ? void 0 : el.showPopover) !== 'function' || !el.isConnected)
            return;
    ...
    render() {
        return (index.h("div", { key: 'be211d172965f4370d2c3706991b9cd6161acde5', class: "tk-popover", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'container') }, index.h("slot", { key: '7f50da600e66887cd1312b7666c42a15146960cd', name: "trigger" }), this.isOpen && (index.h("div", { key: 'c463c4c429b67a926bddd8926f69c80a8d2ed8fd', ref: el => (this.popoverElement = el),
            ...
            popover: "manual", class: {
                'tk-popover-content': true,
                [`tk-popover-${this.type}`]: true,
            }, style: Object.assign({}, this.containerStyle), role: "popover", onClick: e => e.stopPropagation(), "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'content') }, this.hasContentSlot && index.h("slot", { key: 'efff89e8011bf4c8f7e46e098fd798d80ac65c22', name: "content" }), index.h("div", { key: '5b529b932f62bb16f06db65bfe6c6c0513969c6d', ref: el => (this.arrowElement = el), class: "tk-popover-arrow", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'arrow') })))));
    }
...
TkPopover.style = tkPopoverCss();

exports.tk_popover = TkPopover;
