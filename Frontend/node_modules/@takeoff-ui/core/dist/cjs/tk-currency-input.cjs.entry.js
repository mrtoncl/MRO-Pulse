...
const TkCurrencyInput = class {
    ...
    updatePosition() {
        ...
        this.cleanup = positionUtils.floatingElementAutoUpdate(tkInputRootEl, this.dropdownEl, undefined, {
    ...
    renderLabel() {
        if (this.label) {
            return (index.h("label", { class: "tk-currency-input-label", htmlFor: this.uniqueId }, index.h("span", { class: "tk-currency-input-label-title" }, this.label), this.showAsterisk && index.h("span", { class: "tk-currency-input-label-asterisk" }, "*")));
        }
        return null;
    }
    renderCurrencyInput() {
        return (index.h("input", { id: this.uniqueId, ref: el => (this.inputElement = el), type: "text", class: "tk-currency-input-input", autoComplete: "off", value: this.displayValue, placeholder: this.placeholder, disabled: this.disabled, readonly: this.readonly, name: this.name, onInput: this.handleInput, onPaste: this.handlePaste, onKeyDown: this.handleKeyDown, onFocus: this.handleFocus, onBlur: this.handleBlur }));
    }
    renderCurrencySelector() {
        return (index.h("div", { class: "tk-currency-input-dropdown" }, this.renderDropdownButton(), this.isDropdownOpen && (index.h("div", { class: "tk-currency-input-dropdown-menu", role: "listbox", ref: el => (this.dropdownEl = el) }, this.renderCurrencyList()))));
    }
    /**
     * Get the flag class based on the currency's ID.
     */
    getFlagClass(currency) {
        return index$1.classNames('flag', (currency === null || currency === void 0 ? void 0 : currency.id) ? `flag-${currency === null || currency === void 0 ? void 0 : currency.id.toLowerCase()}` : 'flag-none');
    }
    renderDropdownButton() {
        var _a;
        return (index.h("button", { type: "button", class: "tk-currency-input-dropdown-button", onClick: event => this.toggleDropdown(event), disabled: this.currencyDisabled || this.disabled, "aria-disabled": this.currencyDisabled || this.disabled }, index.h("div", { class: "tk-currency-input-dropdown-button-selected" }, !this.hideFlag && this.renderFlag(this.selectedCurrency), index.h("span", { class: "tk-currency-input-dropdown-button-currency-code" }, (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code), !this.currencyDisabled && index.h("tk-icon", Object.assign({}, iconUtils.getIconElementProps('keyboard_arrow_down', { variant: null, size: 'large' }, 'rounded', 'span'))))));
    }
    renderCurrencyList() {
        const currencies = this.getCurrencies();
        return (index.h("ul", { class: "tk-currency-input-dropdown-menu-list" }, currencies.map(currency => (index.h("li", { class: "tk-currency-input-dropdown-menu-list-item", key: currency.code, role: "option", onClick: event => this.handleSelectCurrency(currency.code, event), "aria-selected": this.selectedCurrency.code === currency.code }, !this.hideFlag && this.renderFlag(currency), index.h("span", { class: "tk-currency-input-dropdown-menu-list-country-label" }, currency.symbol), index.h("span", { class: "tk-currency-input-dropdown-menu-list-dial-id" }, currency.name))))));
    }
    /**
    ...
    renderFlag(currency) {
        ...
        return (currency === null || currency === void 0 ? void 0 : currency.id) ? (index.h("div", { class: flagClass, "aria-label": `${currency.code} flag` })) : (index.h("div", { class: flagClass }, index.h("tk-icon", Object.assign({}, iconUtils.getIconElementProps('close', { color: 'var(--static-white)' })))));
    }
    render() {
        return (index.h("div", { key: '16c9ece4d3aea0b2da9ac711490cf4822e5641e6', class: index$1.classNames('tk-currency-input-container', `tk-currency-input-container-${this.size}`), "aria-invalid": this.invalid, "aria-disabled": this.disabled, "aria-readonly": this.readonly }, this.renderLabel(), index.h("div", { key: '298ecd3e714094b16ea7e31e982cf78183a3179f', class: "tk-currency-input-wrapper" }, this.renderCurrencyInput(), this.renderCurrencySelector()), hintUtils.renderHint(this.hint, this.error, this.invalid)));
    }
...
exports.tk_currency_input = TkCurrencyInput;
