 ...
 */
const renderIcons = (icon, options = {}, position = 'left') => {
    ...
    if (isMultiIconOptions(icon)) {
        ...
        if (leftIconConfig) {
            leftIcon = index.h('tk-icon', Object.assign({}, getIconElementProps(leftIconConfig, Object.assign(Object.assign({ variant, sign, size, fill }, additionalProps), { 'data-testid': testIdUtils.getDataTestId(dataTestid, 'left-icon') }), iconStyle, iconTag)));
        }
        if (rightIconConfig) {
            rightIcon = index.h('tk-icon', Object.assign({}, getIconElementProps(rightIconConfig, Object.assign(Object.assign({ variant, sign, size, fill }, additionalProps), { 'data-testid': testIdUtils.getDataTestId(dataTestid, 'right-icon') }), iconStyle, iconTag)));
        }
    }
    else {
        // Single icon with position control
        const iconElement = index.h('tk-icon', Object.assign({}, getIconElementProps(icon, Object.assign(Object.assign({ variant, sign, size, fill }, additionalProps), { 'data-testid': testIdUtils.getDataTestId(dataTestid, `${position}-icon`) }), iconStyle, iconTag)));
        if (position === 'left') {
...
exports.getIconElementProps = getIconElementProps;
exports.isMultiIconOptions = isMultiIconOptions;
