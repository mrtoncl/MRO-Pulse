...
const createToast = (options) => {
    ...
    if (!['top-right', 'bottom-right', 'bottom-left', 'top-left'].includes(options.position))
    ...
    if (((_a = options.header) === null || _a === void 0 ? void 0 : _a.length) > 0)
        tkAlert.header = options.header;
    if (((_b = options.message) === null || _b === void 0 ? void 0 : _b.length) > 0)
        tkAlert.message = options.message;
    tkAlert.setAttribute('type', options.type);
    tkAlert.setAttribute('variant', options.variant);
    if (((_c = options.alignItems) === null || _c === void 0 ? void 0 : _c.length) > 0)
        tkAlert.alignItems = options.alignItems;
    if (((_d = options.icon) === null || _d === void 0 ? void 0 : _d.length) > 0)
        tkAlert.icon = options.icon;
    if (((_e = options.iconSize) === null || _e === void 0 ? void 0 : _e.length) > 0)
        tkAlert.iconSize = options.iconSize;
    if (options.removable)
        tkAlert.removable = options.removable;
    if (((_f = options.actions) === null || _f === void 0 ? void 0 : _f.length) > 0) {
        ...
        options.actions.forEach(item => {
            ...
            if (typeof item.action == 'function')
                button.addEventListener('tk-click', () => item.action());
...
const showPersistentToast = (options) => {
    ...
    const tkAlert = document.createElement('tk-alert');
    if (((_a = toastOptions.header) === null || _a === void 0 ? void 0 : _a.length) > 0)
        tkAlert.header = toastOptions.header;
    if (((_b = toastOptions.message) === null || _b === void 0 ? void 0 : _b.length) > 0)
        tkAlert.message = toastOptions.message;
    tkAlert.setAttribute('type', toastOptions.type);
    tkAlert.setAttribute('variant', toastOptions.variant);
    if (((_c = toastOptions.alignItems) === null || _c === void 0 ? void 0 : _c.length) > 0)
        tkAlert.alignItems = toastOptions.alignItems;
    if (((_d = toastOptions.icon) === null || _d === void 0 ? void 0 : _d.length) > 0)
        tkAlert.icon = toastOptions.icon;
    if (((_e = toastOptions.iconSize) === null || _e === void 0 ? void 0 : _e.length) > 0)
        tkAlert.iconSize = toastOptions.iconSize;
    if (toastOptions.removable)
        tkAlert.removable = toastOptions.removable;
...
exports.dismissAllPersistentToasts = dismissAllPersistentToasts;
exports.isPersistentToastVisible = isPersistentToastVisible;
exports.showPersistentToast = showPersistentToast;
