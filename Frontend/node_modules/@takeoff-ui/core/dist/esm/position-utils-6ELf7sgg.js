...
function positionFloatingElement(triggerElement, floatingElement, arrowElement, options) {
...
function floatingElementAutoUpdate(triggerElement, floatingElement, arrowElement, options, handlePlacement) {
    return autoUpdate(triggerElement, floatingElement, () => {
        positionFloatingElement(triggerElement, floatingElement, arrowElement, options).then(position => void 0 );
    }, { animationFrame: true });
}

export { applyStyles as a, floatingElementAutoUpdate as f, hideElement as h, showElement as s };
