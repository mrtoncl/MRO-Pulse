...
const TkDrawer = class {
    ...
    createHeader() {
        ...
        return (h("div", { class: classNames('tk-drawer-header', `tk-drawer-header-${this.headerType}`), "data-testid": getDataTestId(this.dataTestid, 'header') }, hasHeaderSlot ? (h("slot", { name: "header" })) : this.header ? (h("span", { class: "tk-drawer-header-label", "data-testid": getDataTestId(this.dataTestid, 'label') }, this.header)) : null, hasHeaderActionsSlot ? (h("slot", { name: "header-actions" })) : (!this.hideCloseIcon && (h("tk-button", { class: "tk-drawer-close", variant: "neutral", icon: "close", type: "text", "onTk-click": this.handleCloseButtonClick, dataTestid: getDataTestId(this.dataTestid, 'close-button') })))));
    }
    createFooter() {
        const hasFooterSlot = !!this.el.querySelector('[slot="footer"]');
        if (hasFooterSlot) {
            return (h("div", { class: classNames('tk-drawer-footer', `tk-drawer-footer-${this.footerType}`), "data-testid": getDataTestId(this.dataTestid, 'footer') }, h("slot", { name: "footer" })));
        }
        return null;
    }
    createDrawer() {
        ...
        return (h("div", { class: drawerClass, style: style, "data-testid": getDataTestId(this.dataTestid, 'panel') }, h("div", { class: "tk-drawer-content", "data-testid": getDataTestId(this.dataTestid, 'content') }, h("slot", { name: "container" }, this.createHeader(), h("div", { class: "tk-drawer-body", "data-testid": getDataTestId(this.dataTestid, 'body') }, h("slot", { name: "content" })), this.createFooter()))));
    }
    renderMask() {
        ...
        return (h("div", { class: maskClasses, "data-testid": getDataTestId(this.dataTestid, 'mask') }, h("div", { class: "tk-drawer-overlay", onClick: () => this.handleOverlayClick(), "data-testid": getDataTestId(this.dataTestid, 'overlay') }), this.createDrawer()));
    }
    render() {
...
TkDrawer.style = tkDrawerCss();

export { TkDrawer as tk_drawer };
